...
def load_detections(result_file, score_threshold=0.25):
    pred_boxes = []
...
def process_subfolder(subfolders, index):
    ...
    output_folder = f"./visualization_results/{subfolder_name}/0.25"  # 캡처 이미지 저장 폴더
...
if __name__ == '__main__':
    ...
    folder_index = 2  # 원하는 하위 폴더 인덱스 입력
    main(folder_index)
